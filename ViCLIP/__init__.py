...
def get_text_feat(input_text, tokenizer, clip, text_feature_dict={}): #added a function to get features for single query
    return clip.get_text_features(input_text, tokenizer, text_feature_dict)
